...
curl -Ls https://snapshots.takeshi.team/agoric/genesis.json > $HOME/.agoric/config/genesis.json
curl -Ls https://snapshots.takeshi.team/agoric/addrbook.json > $HOME/.agoric/config/addrbook.json

# Add seeds
sed -i -e "s|^seeds *=.*|seeds = \"400f3d9e30b69e78a7fb891f60d76fa3c73f0ecc@agoric.rpc.takeshi.team:27659\"|" $HOME/.agoric/config/config.toml
