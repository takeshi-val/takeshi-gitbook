...
```bash
STATE_SYNC_RPC=https://kujira.rpc.takeshi.team:443
STATE_SYNC_PEER=d9bfa29e0cf9c4ce0cc9c26d98e5d97228f93b0b@kujira.rpc.takeshi.team:13656
...
```bash
curl -L https://snapshots.takeshi.team/kujira/wasm_latest.tar.lz4 | lz4 -dc - | tar -xf - -C $HOME/.kujira
```
