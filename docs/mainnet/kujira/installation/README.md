...
curl -Ls https://snapshots.takeshi.team/kujira/genesis.json > $HOME/.kujira/config/genesis.json
curl -Ls https://snapshots.takeshi.team/kujira/addrbook.json > $HOME/.kujira/config/addrbook.json

# Add seeds
sed -i -e "s|^seeds *=.*|seeds = \"400f3d9e30b69e78a7fb891f60d76fa3c73f0ecc@kujira.rpc.takeshi.team:13659\"|" $HOME/.kujira/config/config.toml
