...
| BLOCK             | AGE             | DOWNLOAD                                                                                            |
| ----------------- | --------------- | --------------------------------------------------------------------------------------------------- |
| 456692 | 1 hours | [snapshot (0.62 GB)](https://snapshots.takeshi.team/archway-testnet/snapshot\_latest.tar.lz4) |
...
```bash
curl -L https://snapshots.takeshi.team/archway-testnet/snapshot_latest.tar.lz4 | tar -Ilz4 -xf - -C $HOME/.archway
