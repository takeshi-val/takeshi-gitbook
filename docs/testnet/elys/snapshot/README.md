...
| BLOCK             | AGE             | DOWNLOAD                                                                                            |
| ----------------- | --------------- | --------------------------------------------------------------------------------------------------- |
| 1021541 | 2 hours | [snapshot (2.81 GB)](https://snapshots.takeshi.team/elys-testnet/snapshot\_latest.tar.lz4) |
...
```bash
curl -L https://snapshots.takeshi.team/elys-testnet/snapshot_latest.tar.lz4 | tar -Ilz4 -xf - -C $HOME/.elys
