...
**pruning**: 100/0/19 | **indexer**: null | **version tag**: agorictest-upgrade-8

| BLOCK             | AGE             | DOWNLOAD                                                                                            |
| ----------------- | --------------- | --------------------------------------------------------------------------------------------------- |
| 2654107 | 5 hours | [snapshot (1.69 GB)](https://snapshots.takeshi.team/agoric-testnet/snapshot\_latest.tar.lz4) |
