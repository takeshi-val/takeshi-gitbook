...
curl -Ls https://snapshots.takeshi.team/ojo-testnet/genesis.json > $HOME/.ojo/config/genesis.json
...
Also you can check that your pricefeeder-wallet is doing transactions on chain at [Chain Explorer](https://explorer.takeshi.team/ojo-testnet)
